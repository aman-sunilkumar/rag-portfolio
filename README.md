...
Projects built to demonstrate production AI engineering skills.
...
→ [`project2-local-llm/`](./project2-local-llm)

## Stack
Python · FastAPI · Ollama · ChromaDB · LangChain · Pydantic · GitHub Actions
